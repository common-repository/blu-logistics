...
class WC_Blu_Home_Delivery_Shipping_Method extends WC_Shipping_Method{

    public function __construct(){
    $this->id = 'blu_home_shipping_method';
    $this->method_title = __( 'bluHome', 'woocommerce' );
    ...
    public function init_form_fields(){
      $this->form_fields = array(
        'enabled' => array(
          ...
          'type'      => 'checkbox',
          'label'     => __( 'Enable bluHome', 'woocommerce' ),
          'default'     => 'yes'
        ),
        'title' => array(
          ...
          'default'   => __( 'bluHome', 'woocommerce' ),
        ...
        'description' => array(
                ...
                'default'   => __( 'Get your parcel delivered to your doorstep within 3 business days', 'woocommerce' ),
            ),
            'tracking_url' => array(
          ...
          <script>
            ...
            */
            ...
            jQuery(zoneID).on('click', '.add-zone-buttons a.add', function(){
              ...
              if(jQuery('#woocommerce_blu_home_shipping_method_free_shipping').is(':checked'))
              {
